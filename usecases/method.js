...
class Method{
    ...
    draw(){
        ...
        this.ancre = aya.Circle(this.polyline.x, this.polyline.y, 3);
        this.ancre.draw();
        ...
        this.polyline.draw();
        this.id.draw();
        this.id.c_svg.setAttribute("fill", "#FFFDDE");
        ...
        this.id.addEvent("mousedown", ()=>{
            RectangleEvent.mousedowncb(this);
        });
    }
    ...
    createArtefact(){
        var points = [
            this.id.x + this.id.width,
            this.id.y + this.id.height + 0,
            this.id.x + this.id.width + 0,
            this.id.y + this.id.height +0,
            this.id.x + this.id.width + 0,
            this.id.y + this.id.height +200,
            this.id.x + this.id.width + 200,
            this.id.y + this.id.height +200,
            this.id.x + this.id.width + 200,
            this.id.y + this.id.height + -(100 + this.height - 50),
            this.id.x + this.id.width + 0,
            this.id.y + this.id.height +-( 100 + this.height - 50),
            this.id.x + this.id.width + 0,
        ...
        this.design_pattern.map((pattern, index) =>{
            this.esquiss.addChild(pattern, (p,c) =>{
                if(index == 0){
                    c.setOffsetX(p.x + (1/7 * 100) + 25 + 25);
                    c.setOffsetY((p.y - 30) + 30/2 - 25 - 25);
                }
                if(index == 1){
                    c.setOffsetX(p.x + (1/7 * 100) + 25);
                    c.setOffsetY((p.y - 30) + 30/2 - 25);
                }
                if(index == 2){
                    c.setOffsetX(p.x + (1/7 * 100));
                ...
                if(index == 5){
                    c.setOffsetX(p.x + (1/7 * 100) + 25 + 25);
                    c.setOffsetY((p.y - 30) + 30/2 + 25 + 25 + 25);
                }
            }, (p,c)=>{}, false);
        });
        this.esquiss.draw();
